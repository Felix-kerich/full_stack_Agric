...
import backgroundImage from '@/images/farm-background.jpg'
    ...
    <section className="relative">
      ...
      <Container className="relative pb-16 pt-20 text-center lg:pt-32">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
          Most farming advice is useful, but hard to follow. We make it simple,
          helping you grow healthier crops with the right tools and timing.
        </p>
